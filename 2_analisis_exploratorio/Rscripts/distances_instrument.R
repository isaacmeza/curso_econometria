...
setwd('C:/Users/xps-seira/Dropbox/Apps/ShareLaTeX/curso_econometria/2_analisis_exploratorio/Rscripts')

# Read in the CSV data and store it in a variable

origAddress <- read.csv('../../DB/direcciones_p1.csv', stringsAsFactors = FALSE)
...
write.csv(origAddress, "../../DB/geocoded_p1.csv", row.names=FALSE)




geocoded <- read.csv('../../DB/geocoded_p1.csv', stringsAsFactors = FALSE) %>% 
  drop_na()
...
# If you want to set a profile other than car.lua
...
write.csv(geocoded, "../../DB/geocoded_distances_p1.csv", row.names=FALSE)
